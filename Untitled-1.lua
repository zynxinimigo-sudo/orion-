        ...
        local function GetElements(TargetParent)
            ...
            function Elements:CreatePlayerDropdown(Cfg)
                ...
                local Drop = Create("TextButton", {
                    ...
                    BackgroundTransparency = 0.5, Text = "", AutoButtonColor = false, ClipsDescendants = true,
                ...
                local function CreatePlayerRow(plr)
                    ...
                    local UserLabel = Create("TextLabel", {Parent = Btn, Size = UDim2.new(1, -66, 0, 16), Position = UDim2.new(0, 42, 0, 22), BackgroundTransparency = 1, Text = "(@" .. plr.Name .. ")", Font = Library.GlobalFont, TextColor3 = SelectedTheme.TextDark, TextTransparency = 0.25, TextSize = 11, TextXAlignment = Enum.TextXAlignment.Left, TextTruncate = Enum.TextTruncate.AtEnd, ZIndex = 10, ThemeTag = "TextDark"})
                ...
                local function CreateDisconnectedRow(uid, info)
                    ...
                    local UserLabel = Create("TextLabel", {Parent = Btn, Size = UDim2.new(1, -44, 0, 16), Position = UDim2.new(0, 10, 0, 22), BackgroundTransparency = 1, Text = "(@" .. (info.UserName or "desconectado") .. ")", Font = Library.GlobalFont, TextColor3 = SelectedTheme.TextDark, TextTransparency = 0.25, TextSize = 11, TextXAlignment = Enum.TextXAlignment.Left, TextTruncate = Enum.TextTruncate.AtEnd, ZIndex = 10, ThemeTag = "TextDark"})
